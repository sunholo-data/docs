...
## {background-image="img/llm-architecture-gcp.png" background-size="100%" data-id="llm-architecture-gcp"}
...
## {background-image="img/Sunholo%20LLMOps%20Cloud%20Architecture.png" data-id="llmopsv3" background-size="45%"}
